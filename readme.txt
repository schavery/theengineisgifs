...
Requirements:
This code is not built with portability in mind. The host machine needs to have apache, php, imagemagick, and node.js installed. I am not sure what versions are required. My host uses:
php 5.4.4 / apache 2.4.2 / xampp 1.8.0
...
Usage:
You'll need to set up a host with your apache configuration. Visit the base URL to see the current gif to be displayed, fullscreen.
